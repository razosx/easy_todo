...
2. The skill will analyze the goal:
...
3. The skill will ask follow-up questions if necessary to clarify the goal or gather additional information to create a more effective plan.
4. The skill will create a md file with the generated plan, which can be easily shared or referenced later. The name of the file will be based on the goal_datetime.md format.
5. Each phase will have 3 states: "To Do" represented by [ ], "In Progress" represented by [X], and "Done" represented by [✓].
6. Each step of the sub-tasks will also have the same 3 states to track progress effectively.
